...
Currency Currency::Normalize(Currency cur)
{
	cur.bill += cur.coin / 100;
	cur.coin = cur.coin % 100;
...
Currency Currency::operator + (const Currency &right)
{
	...
	temp.billname = right.billname;
	temp.coinname = right.coinname;
