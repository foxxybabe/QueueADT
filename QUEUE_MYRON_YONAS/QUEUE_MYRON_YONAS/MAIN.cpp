...
void main()
{
	...
	myQueue.insert("2node", 0);//2nd parameter is supposed to be position to insert or delete, but Queue always does it in position 1 
	...
	myIntQueue.insert(20, 0);//2nd parameter is supposed to be position to insert or delete, but Queue always does it in position 1 
	...
	myCurrencyQueue.insert(egMoney, 0);
	cout << "calling isempty()..." << endl;
